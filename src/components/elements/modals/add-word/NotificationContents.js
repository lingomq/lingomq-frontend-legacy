export const notificationContents = {
    200: {
        2: { level: "success", title: "Добавление слова", message: "Слово успешно добавлено!" }
    },
    400: {
        0: { level: "warning", title: "Ошибка добавления пароля", message: "Отправлены некорректные данные"},

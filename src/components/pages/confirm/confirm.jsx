...
import notificationManager, {notificationModel} from "../../structure/notify/notificationManager.js";
...
export const Confirm = () => {
	...
	return (
		<div className="confirm">
			<p>{isValid ? "Ваш аккаунт подтвержден. Вы можете закрыть эту страницу и войти в свой аккаунт" : "Неверный токен" }</p>
		</div>
	);
};

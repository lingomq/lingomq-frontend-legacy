...
export const Security = () => {
    ...
    function openModal(type) {
        console.log(data);
        let view = <NonSensitiveData userData={data.user}/>;
        if (type === "non-credentials") view = <NonSensitiveData userData={data.user}/>;
        else if (type === "change-password")
            view = <ChangePassword verificationText={"lingomq/" + data.nickname} />;
        else if (type === "remove-account")
            view = <RemoveAccount verificationText={"lingomq/" + data.nickname} />;

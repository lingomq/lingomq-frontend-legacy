      ...
      <div className={styles.main}>
        ...
        <div className={styles.mainSelector}>
          <div className={styles.mainSelectorContent}>
            <p onClick={changeView} className={`${isTopicShow? styles.selected: ""}`}>ТОПИКИ</p>
            <p onClick={changeView} className={`${!isTopicShow? styles.selected: ""}`}>РЕКОРДЫ</p>
          </div>
        </div>
        <div className={styles.mainSection}>
          <div className={`${styles.topicsSection} ${isTopicShow? "" : styles.disabled}`}>
            ...
            <div className={styles.topicCard}>
              ...
              <p className={styles.topicCardTitle}>Название топика</p>
          ...
          <div className={`${styles.recordsSection} ${!isTopicShow || window.innerWidth >= 1050? "" : styles.disabled}`}>
